function run_kapal_video(varargin)
%run_kapal_video Demonstration of the detector
...
%    The matconvnet wrapper to be used (both dagnn and autonn are supported) 
  ...
  % Load video path
  video_path ='./misc/test_video2.mp4';
  v = VideoReader(video_path);
  
  while hasFrame(v)
      im = single(readFrame(v));
